...
<head>
    ...
    <style>
        ...
        .jumbotron {
            ...
            color: white;
            text-align: center;
            background: url('images/Africa.jpg') no-repeat center fixed;
                ...
                <form action="subir_action.php" method="post" accept-charset="utf-8" enctype="multipart/form-data" onsubmit="return submitform();">
                    ...
                    <span><label class="ciudad" for="ciudad" required>Ciudad:
                        <select name="ciudad" id="ciudad" required>
                            <optgroup label="Camerún">
                                <option value="Yaundé, Camerún">Yaundé</option>
                            </optgroup>
                            <optgroup label="Etiopía">
                                <option value="Adís Abeba, Etiopía">Adís Abeba</option>
                            </optgroup>
                            <optgroup label="Madagascar">
                                <option value="Antananarivo, Madagascar">Antananarivo</option>
                            </optgroup>
                            <optgroup label="Marruecos">
                                <option value="Rabat, Marruecos">Rabat</option>
                            </optgroup>
                        </select>
                    </label></span>
                    <br><br><br><br>
