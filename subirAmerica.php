...
<head>
    ...
    <style>
        ...
        @media only screen and (min-width:768px){
            ...
            .navbar-custom .nav li a:hover,.navbar-custom .nav li a:focus{color:#404040}
        }
        ...
        .jumbotron {
            ...
            color: white;
            text-align: center;
            background: url('images/America.jpg') no-repeat center fixed;
                    ...
                    <span><label class="ciudad" for="ciudad" required>Ciudad:
                        <select name="ciudad" id="ciudad" required>
                            ...
                            <optgroup label="Canadá">
                                <option value="Quebec, Canadá">Quebec</option>
                            </optgroup>
