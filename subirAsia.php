...
<head>
    ...
    <style>
        ...
        .jumbotron {
            ...
            color: white;
            text-align: center;
            background: url('images/Asia.jpg') no-repeat center fixed;
                    ...
                    <span><label class="ciudad" for="ciudad" required>Ciudad:
                        <select name="ciudad" id="ciudad" required>
                            ...
                            <optgroup label="Filipinas">
                                <option value="Manila, Filipinas">Manila</option>
                            </optgroup>
                            <optgroup label="Japón">
                                <option value="Tokyo, Japón">Tokyo</option>
                            </optgroup>
                            <optgroup label="Tailandia">
                                <option value="Bangkok, Tailandia">Bangkok</option>
                            </optgroup>
                        </select>
                    </label></span>
                    <br><br><br><br>
